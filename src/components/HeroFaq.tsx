...
import Poster from '../../public/heroFaq.webp'; // stessa immagine, cambierai tu se serve
  ...
  return (
    <section className="relative w-full overflow-hidden flex items-end pb-20 h-[100vh] md:h-[80vh] bg-[#F8F6F2]">
      ...
      <LayoutWrapper>
        ...
        >
          <motion.h1
            className="font-caveat font-bold text-yellow-400 drop-shadow-md leading-tight text-[clamp(2.5rem,8vw,4rem)]"
